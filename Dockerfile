...
FROM $BASE_IMAGE
LABEL maintainer="Yawei Su <comespace2@gmail.com> and Liqiang huang <liqiang37uh@gmail.com>" \
      author="Yawei Su <comespace2@gmail.com> and Liqiang huang <liqiang37uh@gmail.com>" \
